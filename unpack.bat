...
bin\windows\make_ext4fs -s -L system -T -6 -S bin\tmp\system\system_file_contexts -C bin\tmp\system\system_fs_config -l %systemsize%0 -a system bin\tmp\system.img bin\tmp\system\system >nul >> log.txt
