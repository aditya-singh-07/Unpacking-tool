...
class Extractor(object):
    ...
    def __ext4extractor(self):
        ...
        contexts = self.BASE_DIR + "file_contexts"
        fs_config_file = 'fs_config'
        ...
        f = open(self.BASE_DIR + os.path.basename(self.OUTPUT_IMAGE_FILE).split('.')[0] +'_size.txt', 'tw', encoding='utf-8')
